...
\title{Meeting Notes - 14 April 2026}
...
\section*{A. Recap From The Last Meeting}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{../paper/paper_v4_institutional_commons/figures/harvest_architecture_stageC_architecture.png}
  \caption{Baseline Harvest architecture result from the completed benchmark line. This is the strongest finished non-LLM result in the project. It shows the large confirmatory Harvest comparison in which hybrid governance ranks first across all eight main decision cells.}
\end{figure}
...
\section*{B. Current Progress Since That Meeting}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.88\linewidth]{../paper/paper_v4_institutional_commons/figures/institutional_friction_winner_map.png}
  \caption{Summary of the newer institutional-friction extension. This figure shows that the ranking between hybrid and top-down-only governance changes across scenario families and oversight settings, which is the main new result in the current manuscript.}
\end{figure}

\section*{C. Points To Discuss In The Meeting}
...
\section*{D. Problem Definition For The Next Stage}
...
\section*{E. Methodology Direction For The Next Stage}
